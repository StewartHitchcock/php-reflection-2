                    ...
                    <header>
                                ...
                                <div class="pushy-content">
                                    <ul>
                                        <div class = "pushy-mob-menu">
                                            ...
                                            <div class="nav-button nav-bar-web"><div><i class="fas fa-code nav-icn"></i><p>Web</p>Design</div></div>
                                            ...
                                            <div class="nav-button nav-bar-it"><i class="fas fa-desktop nav-icn"></i><p>IT</p>Support</div>
                                            <div class ="sub-menu-pushy">
                                            ...
                                            <div class="nav-button nav-bar-telecoms"> <i class="fas fa-phone-volume nav-icn"></i><p>Telecoms</p>Services</div>
                                            <div class ="sub-menu-pushy">
                                            ...
                                            <div class="nav-button nav-bar-bespoke"><i class="fas fa-th nav-icn"></i><p>Bespoke</p>Software</div>
                                            <div class ="sub-menu-pushy">
                                            ...
                                            <div class="nav-button nav-bar-digital"><i class="fas fa-chart-bar nav-icn"></i><p>Digital</p>Marketing</div>
                                            <div class ="sub-menu-pushy">
                                            ...
                                            <div class="nav-button nav-bar-cyber"><i class="fas fa-shield-alt nav-icn"></i><p>Cyber</p>Security</div>
                                            <div class ="sub-menu-pushy">
                                        ...
                                        <li class="pushy-link pushy-sub"><a href="#"> <i class="fas fa-angle-double-right"></i>Wed Developer Course</a></li>
                                        <li class="pushy-link pushy-head"><a href="#">Events</a></li>
                                        <li class="pushy-link pushy-sub"><a href="#"> <i class="fas fa-angle-double-right"></i>Business Automation Seminar</a></li>
                                        <li class="pushy-link pushy-head"><a href="#">Our Company</a></li>
                                        <li class="pushy-link pushy-sub"><a href="#"> <i class="fas fa-angle-double-right"></i>Our Culture</a></li>
                                        <li class="pushy-link pushy-sub"><a href="#"> <i class="fas fa-angle-double-right"></i>Our Team</a></li>
                                        <li class="pushy-link pushy-sub"><a href="#"> <i class="fas fa-angle-double-right"></i>Our Careers</a></li>
                                        <li class="pushy-link pushy-sub"><a href="#"> <i class="fas fa-angle-double-right"></i>Our Benefits</a></li>
                                        <li class="pushy-link pushy-sub"><a href="#"> <i class="fas fa-angle-double-right"></i>Our Great Yarmouth Office</a></li>
                                        <li class="pushy-link pushy-head"><a href="#">Our Work</a></li>
                                        <li class="pushy-link pushy-sub"><a href="#"> <i class="fas fa-angle-double-right"></i>Case Studies</a></li>
                                        <li class="pushy-link pushy-head"><a href="#">Our Knowledge</a></li>
                                        <li class="pushy-link pushy-sub"><a href="#"> <i class="fas fa-angle-double-right"></i>Guides</a></li>
                                        <li class="pushy-link pushy-sub"><a href="#"> <i class="fas fa-angle-double-right"></i>News</a></li>
                                        <li class="pushy-link pushy-sub"><a href="#"> <i class="fas fa-angle-double-right"></i>Insights</a></li>
                        ...
                        <div class="navbar">
                            <div class="navbar-buttons">
                                <div class="nav-button nav-bar-web"><i class="fas fa-code nav-icn"></i><p>Web</p>Design      
                                ...
                                <div class="nav-button nav-bar-it"><i class="fas fa-desktop nav-icn"></i><p>IT</p>Support
                                ...
                                <div class="nav-button nav-bar-telecoms"> <i class="fas fa-phone-volume nav-icn"></i><p>Telecoms</p>Services
                                ...
                                <div class="nav-button nav-bar-bespoke"><i class="fas fa-th nav-icn"></i><p>Bespoke</p>Software
                                ...
                                <div class="nav-button nav-bar-digital"><i class="fas fa-chart-bar nav-icn"></i><p>Digital</p>Marketing
                                ...
                                <div class="nav-button nav-bar-cyber"><i class="fas fa-shield-alt nav-icn"></i><p>Cyber</p>Security
